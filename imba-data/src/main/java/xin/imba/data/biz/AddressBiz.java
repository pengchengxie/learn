...
/**
 * 
 * <b>简述：根据IP地址获取详细的地域信息</b>
 * 
 * @author : xiepengcheng 2017年1月17日 上午11:48:44
 */
public class AddressBiz {

	public static String urlStr = "http://ip.taobao.com/service/getIpInfo.php"; // 这里调用pconline的接口
	...
	public static String getCity( String content, String encodingString ) throws UnsupportedEncodingException {
		// 从http://whois.pconline.com.cn取得IP所在的省市区信息
		String returnStr = getResult( urlStr, content, encodingString );
		if ( returnStr != null ) {
			// 处理返回的省市区信息
